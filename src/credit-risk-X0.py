...
CONFIG = {
    ...
    "xgb_params": {
        ...
        "eval_metric": "auc",
        "tree_method": "hist",          # CPU 直方图
        "learning_rate": 0.02,          # 可换 0.01~0.03
        "max_depth": 0,                 # 0=不限深，用 max_leaves 控制
        "max_leaves": 255,              # 类似 LGBM num_leaves
        "min_child_weight": 1.0,        # 类似最小赫塞
        "lambda": 5.0,                  # L2 正则（reg_lambda）
        "alpha": 1.0,                   # L1 正则（reg_alpha）
        "subsample": 0.85,              # bagging
        "colsample_bytree": 0.9,        # feature_fraction
        "max_bin": 512,
        "enable_categorical": True,     # 允许 pandas category
        "verbosity": 0,
